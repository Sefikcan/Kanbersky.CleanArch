...
namespace Kanbersky.CleanArch.Core.Repositories.Abstract.MongoDB
{
    public interface IMongoGenericRepository<TEntity> where TEntity : BaseMongoEntity, IEntity, new()
    {
